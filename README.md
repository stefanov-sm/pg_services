...
- **extsyntax** - optional boolean, default `false`. Sets "extended" SQL query parameter syntax. Applies to `POST` services only. See [SQL query parameter syntax](#sql-query-parameter-syntax) below.
