...
- **extsyntax** - optional boolean, default `false`. Sets "extended" SQL query parameter syntax. Applies to `POST` services only. See [SQL query parameter syntax](https://github.com/stefanov-sm/pg_services/tree/main#sql-query-parameter-syntax) below.
